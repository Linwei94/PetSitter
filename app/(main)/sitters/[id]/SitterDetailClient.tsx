...
const SITTER_DATA: Record<string, any> = {
  '1': {
    ...
    hasChildren: false,
    maxCats: 3,
    bio: `我是一名热爱猫咪的资深铲屎官，在悉尼Chatswood生活多年，有超过5年专职照顾猫咪的经验。曾在当地宠物医院担任助理2年，具备基础医疗知识，可以处理猫咪的日常健康问题。

家中环境温馨舒适，专门为寄养猫咪准备了独立的活动空间，配备了多个猫爬架、抓板和玩具。我深知每只猫咪的性格都不同，会根据猫咪的习性提供个性化照顾。
...
每天会发送至少5张照片和1条视频更新，让您出行无忧！`,
  ...
  '2': {
    ...
    title: '专职猫咪寄养 · 10年经验', city: '悉尼', district: 'Hurstville',
    rating: 4.95, reviewCount: 89, completedBookings: 142, yearsExp: 10,
    responseRate: 97, responseTime: '1小时内', priceBoarding: 75, priceFeeding: undefined,
    additionalCatPrice: 25, services: ['cat_boarding'], idVerified: true, backgroundChecked: true,
    homeType: '独栋', homeSize: '180㎡', hasOutdoorSpace: true, hasOwnPets: false,
    hasChildren: false, maxCats: 4,
    bio: '专职猫咪照顾者，10年经验，常驻悉尼Hurstville华人区。家中有专门的猫咪活动室和后院花园，猫咪可以晒太阳。安装了全屋监控，您可以随时查看。',
